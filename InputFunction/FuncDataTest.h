#ifndef FUNCDATATEST_H_INCLUDED
#define FUNCDATATEST_H_INCLUDED

/**
    Example model functions, using the analytical GR kernel in Poisson gauge + with logarithmic correction.
**/
